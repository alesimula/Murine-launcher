...
public class WallpaperManagerCompatVOMR1 extends WallpaperManagerCompat {
    ...
    private Map<Integer, OnColorsChangedListener> listenerMap = new HashMap<>();
    ...
    public void addOnColorsChangedListener(final OnColorsChangedListenerCompat listener) {
        listenerMap.computeIfAbsent(System.identityHashCode(listener), hash -> {
            var onChangeListener = new OnColorsChangedListener() {
                @Override
    ...
    @Override
    public void removeOnColorsChangedListener(OnColorsChangedListenerCompat listener) {
        var onChangeListener = listenerMap.remove(System.identityHashCode(listener));
        if (onChangeListener != null) mWm.removeOnColorsChangedListener(onChangeListener);
    }
